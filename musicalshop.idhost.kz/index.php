...
<div id="block-body">
	...
	<div id="block-content">	
		<div id="block-sorting">	
			<p id="nav-main"><a href="index.php">Главная страница</a> \ <span>Все товары</span></p>
				<ul id="sort-list">
					<li>Вид: </li>	
	...
	$count = mysql_query("SELECT COUNT(*) FROM items WHERE items_visible = '1'",$link);
...
$result = mysql_query("SELECT * FROM items where items_visible='1'  ORDER by $sorting $qury_start_num", $link);  
...
(function(){ var widget_id = '3O22r5BrS3';
