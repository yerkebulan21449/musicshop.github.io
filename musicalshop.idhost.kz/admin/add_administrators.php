...
if ($_POST["submit_add"])
{
    ...
    if ($_POST["admin_login"])
    {
        ...
        $query = mysql_query("SELECT admin_login FROM admin WHERE admin_login='$login'",$link);
 ...
 {
    $pass   = clear_string($_POST["admin_pass"]);
    
    
                        mysql_query("INSERT INTO admin(admin_login,admin_password,fio,role,email,phone,view_orders,accept_orders,delete_orders,add_tovar,edit_tovar,delete_tovar,accept_reviews,delete_reviews,view_clients,delete_clients,add_news,delete_news,add_category,delete_category,view_admin)
                        VALUES(                     
