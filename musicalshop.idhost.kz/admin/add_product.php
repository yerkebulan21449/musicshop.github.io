...
if ($_SESSION['auth_admin'] == "yes_auth")
{
 ...
 // Проверка чекбоксов
       ...
       }else
       {
                  ...
                  mysql_query("INSERT INTO items(items_title,items_price,items_brand,key_words,key_description,mini_description,items_description,mini_features,features,items_new,items_sale,items_visible,items_type,brand_id)
            VALUES(           
                            '".$_POST["form_title"]."',
                            '".$_POST["form_price"]."',
                            '".$selectbrand."',
...
<option value="struna" >Струнные</option>
<option value="naduvnie" >Надувные</option>
<option value="udarnie" >Ударные</option>
