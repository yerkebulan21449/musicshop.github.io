...
{
   if ($_SESSION['auth_admin_login'] == 'madiyar')
   {
...
$result = mysql_query("SELECT * FROM admin WHERE admin_id='$id'",$link);
...
<ul id="info-admin">
<li><label>Логин</label><input type="text" name="admin_login" value="'.$row["admin_login"].'" /></li>
<li><label>Пароль</label><input type="text" name="admin_pass" value="'.$row["admin_password"].'"  /></li>
