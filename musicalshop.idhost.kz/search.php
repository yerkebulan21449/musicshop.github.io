...
<?php
  ...
  {    
	...
	$count = mysql_query("SELECT COUNT(*) FROM items WHERE items_title LIKE '%$search%' AND items_visible = '1'",$link);
...
If ($temp[0] > 0)
{
 ...
 <div id="block-sorting">	
			<p id="nav-main"><a href="index.php">Главная страница</a> \ <span>Поиск</span></p>
				<ul id="sort-list">
					<li>Вид: </li>	
					...
					<li><a id="select-sort"><?php echo $sort_name;
					 ?></a>
						<ul id="sorting-list">
							<li><a href="index.php?sort=price-up">По возрастанию цены</a></li>
							<li><a href="index.php?sort=price-down">По убыванию цены</a></li>
							<li><a href="index.php?sort=popular">Популярное</a></li>
							<li><a href="index.php?sort=news">Новинки</a></li>
							<li><a href="index.php?sort=alph">от А до Я</a></li>
						</ul>
					</li>
				</ul>
		</div>
 ...
 ';   
  ...
  $result = mysql_query("SELECT * FROM items WHERE items_title LIKE '%$search%' AND items_visible='1' ORDER BY $sorting $qury_start_num ",$link);  
...
{
    echo "<p><strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspНичего не найдено!</strong></p>";
}
  }else
  {
     echo "<p><strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspЗначение должно быть от 3 до 150 символов!</strong></p>";
  }
?>
